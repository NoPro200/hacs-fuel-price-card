...
The reason I created this map is because Tankerkönig does not provide prices for Ultimate Diesel or Ultimate 102, which is why the Tankerkönig card on which it is based is not possible for this purpose, and I therefore retrieve this information via web scraping. 
